...
#            str_function='lh'
        if(funct3=='010'):
            str_function='lw'
            array_register[int_rd]=array_register[int_decimm+int_res1]
#        elif(funct3=='100'):
#            str_function='lbu'
#        elif(funct3=='101'):
#            str_function='lhu'
...
#            str_function='sh'
        if (funct3=='010'):
            str_function='sw'
            array_register[int_res1+int_decimm]=array_register[int_res2]
        else:
            str_function='NoFunct'
...
with open("proj2_4_inst.bin", 'rb') as file1:
...
#        print('x'+str(i)+': '+hex(array_register[i]))
